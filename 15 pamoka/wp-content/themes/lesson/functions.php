...
function lesson_setup() {
	/*
		...
		* If you're building a theme based on lesson, use a find and replace
		* to change 'lesson' to the name of your theme in all the template files.
		*/
 ...
 */
function lesson_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'lesson_content_width', 640 );
}
add_action( 'after_setup_theme', 'lesson_content_width', 0 );
